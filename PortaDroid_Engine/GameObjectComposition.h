...
namespace OBALFramework
{
  ...
  /// "It seems to me that this function is useless because you can just get the component and check its id"
  /*
...
/// #define has(type) GetComponentType<type>( CT_##type )  !!FROM SAMPLE ENGINE!!
